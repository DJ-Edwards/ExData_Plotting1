...
#create plot1
hist(as.numeric(Power_subset1$Global_active_power),col= "red",main="Global Active Power",ylab="Frequency",xlab = "Global Active Power (kilowatts)")

#save and store plot1
